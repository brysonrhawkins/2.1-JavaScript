...
//Code Here
let myStrongest  = monstersInYourPocket.filter(element => element.CP >= 201)
...
let bobsTotal = purchases.reduce((acc, element) => element.owner === 'Bob' ? acc + element.price : acc + 0, 0)


/// Notes: dont forget to use the question mark ternary operator, makes code look cleaner///